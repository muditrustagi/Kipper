...
"""
EXTENSION:
    stores all the extensions that the app considers while running
    add/delete/edit the extensions that you want to include/exclude
...
"""
LANGUAGES:
    stores the mapped language code and its name
    add/delete/edit the language code/name as per your suitability
"""
